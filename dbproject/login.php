...
<body>
    ...
    <div id="container-all">
        <!-- Sidebar Code -->
        <div id="sidebar">
            <div id="doclogin" class="sd-list"><a href="adminlogin.php">Admin Login</a></div>
            <div id="doclogin" class="sd-list"><a href="doctorlogin.php">Doctor Login</a></div>
            <div id="doclogin" class="sd-list"><a href="nurselogin.php">Nurse Login</a></div>
            <div id="doclogin" class="sd-list"><a href="wardboylogin.php">WardBoy Login</a></div>
            <div id="doclogin" class="sd-list"><a href="patientlogin.php">Patient Login</a></div>
            <div id="doclogin" class="sd-list"><a href="supportgrouplogin.php">SupportGroup Login</a></div>
        </div>
        <!-- Slider Code -->
        <!-- <div id="slider">
        ...
        <div id="video">
            <video autoplay muted loop id="myVideo">
                <source src="img/hms_updated.mp4" type="video/mp4">
            </video>
        </div>
        <!-- container-all ended  -->
    </div>
