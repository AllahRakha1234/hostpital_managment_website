...
<body">
    ...
    <table style="width: 80vw; line-height: 5vh; margin-top: 5vh;">
        ...
        <t>
            ...
            $sql_doctor_nurse = 'SELECT * FROM project.dn_relation where dn_relation.DoctorEmail = "'.$email_email_id.'"';
            $result_doctor_nurse = mysqli_query($dbconn, $sql_doctor_nurse);
            while ($row_doctor_nurse = mysqli_fetch_assoc($result_doctor_nurse)) {
            ?>
            <tr>
                <td><?php echo $row_doctor_nurse['nurse_id']; ?> </td>
                <td><?php echo $row_doctor_nurse['name']; ?> </td>
                <td><?php echo $row_doctor_nurse['phone_no']; ?> </td>
                <td><?php echo $row_doctor_nurse['email']; ?> </td>
                <td><?php echo $row_doctor_nurse['DoctorEmail']; ?> </td>
            </tr>
            <?php
            }
            ?>
