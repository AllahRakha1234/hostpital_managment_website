...
<body style='background: url("img/bgdoctor.jpg") no-repeat center center/cover;'>
    ...
    <div id="doc-container" class="adm-container">
        <div id="doctor-login" class="adm-login">
            <form action="doctorlogin.php" method="POST">
                <h3>Login Page</h3>
                Email: <br><input type="text" name="doctor-email" id="doctor_email"><br>
                Password: <br><input type="text" name="doctor-password" id="doctor_password"><br>
                <input type="submit" name="Submit" id="doctor-submit-btn" class="adm-submit-btn">
            </form>
        </div>
    </div>
    <!-- Footer -->
