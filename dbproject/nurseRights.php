...
<body>
    ...
    <nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><a href="nurselogin.php">Back</a></li>
            <li class="item"><a href="#clients-section">Clients</a></li>
            <li class="item"><a href="#contact-section">Contact Us</a></li>
        </ul>
    </nav>
    <div id="nurse-container-compnents" class = "container-compnents">
        <div id="wardboy-doctor_box" class="box-decor doctor-box">
            <div id="doctor">
                <div id="doctor-link" class="boxes-text-decor"><a href="nurseRightsDoctor.php"
                        class="boxes-link-decor">Report To Doctors</a></div>
            </div>
        </div>
        <div id="wardboy-nurse_box" class="box-decor nurse-box">
            <div id="nurse">
                <div id="nurse-link" class="boxes-text-decor"><a href="nurseRightsPI.php"
                        class="boxes-link-decor">Personal Info</a></div>
            </div>
        </div>
        <div id="wardboy-patient_box" class="box-decor patient-box">
            <div id="patient">
                <div id="patient-link" class="boxes-text-decor"><a href="nurseRightsPatient.php"
