...
<body">
    ...
    <nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><a href="wardboyRights.php">Back</a></li>
    ...
    <table style="width: 80vw; line-height: 5vh; margin-top: 5vh;">
        ...
        <t>
            ...
            $sql_ward_boy_doctor = 'SELECT * FROM project.wbd_relation where wbd_relation.WardBoyEmail = "'.$email_email_id.'"';
            $result_ward_boy_doctor = mysqli_query($dbconn, $sql_ward_boy_doctor);
            while ($row_ward_boy_doctor = mysqli_fetch_assoc($result_ward_boy_doctor)) {
            ?>
            <tr>
                <td><?php echo $row_ward_boy_doctor['doctor_id']; ?> </td>
                <td><?php echo $row_ward_boy_doctor['name']; ?> </td>
                <td><?php echo $row_ward_boy_doctor['phone_no']; ?> </td>
                <td><?php echo $row_ward_boy_doctor['email']; ?> </td>
                <td><?php echo $row_ward_boy_doctor['WardBoyEmail']; ?> </td>
            </tr>
            <?php
            }
            ?>
