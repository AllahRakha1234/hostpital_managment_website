...
<body>
    ...
    <nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><a href="supportgrouplogin.php">Back</a></li>
            <li class="item"><a href="#clients-section">Clients</a></li>
            <li class="item"><a href="#contact-section">Contact Us</a></li>
        </ul>
    </nav>
    <div id="supportgroup-container-compnents" class = "container-compnents">
        <div id="supportgroup-attendbox" class="box-decor call-box">
            <div id="supportgroup">
                <div id="doctor-link" class="boxes-text-decor"><a href="sgAttendedCalls.php"
                        class="boxes-link-decor">Attended Calls</a></div>
            </div>
        </div>
        <div id="supportgroup-unattendcall_unattended_box" class="box-decor call-box">
            <div id="supportgroup">
                <div id="doctor-link" class="boxes-text-decor"><a href="sgUnattendedCalls.php"
                        class="boxes-link-decor">Unattended Calls</a></div>
            </div>
        </div>
