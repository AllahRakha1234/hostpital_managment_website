...
function chkadminValidiation($email, $password, $conn){
    ...
    $sql = 'SELECT * FROM nurse where nurse.email = "'.$email.'"AND pass = "'.$password.'";';
    echo($sql);
...
$nurse_email = $_GET["nurse-email"];
$nurse_password = $_GET["nurse-password"];

chkadminValidiation($nurse_email, $nurse_password, $dbconn);
