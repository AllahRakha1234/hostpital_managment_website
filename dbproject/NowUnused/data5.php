...
function chkadminValidiation($email, $password, $conn){
    ...
    $sql = 'SELECT * FROM patient where patient.email = "'.$email.'"AND pass = "'.$password.'";';
    // echo($sql);
...
$patient_email = $_GET["patient-email"];
$patient_password = $_GET["patient-password"];

chkadminValidiation($patient_email, $patient_password, $dbconn);
